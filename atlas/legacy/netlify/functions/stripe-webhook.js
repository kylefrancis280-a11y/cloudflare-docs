// stripe-webhook.js
// Handles Stripe checkout, subscription updates, and payment failures
// Updates Firebase users with tier and subscription status
...
exports.handler = async (event) => {
  ...
  if (STRIPE_WEBHOOK_SECRET && !verifySignature(event.body, sig)) {
  ...
  try {
    ...
    console.log('Stripe webhook:', ev.type);
